      ...
      {isConnected ? (
        <div className="space-y-4">
          ...
          {settings.fb_page_name && (
            <div>
              <span className="text-gray-400">Página de Facebook:</span>{' '}
              <span className="text-white font-medium">{settings.fb_page_name}</span>
            </div>
          )}
          ...
          {settings.ig_user_id && (
            <div className="flex items-center gap-2 text-green-400">
              ...
              <span>Instagram Business conectado</span>
            </div>
          )}
